...
return require('packer').startup({
    function(use)
        ...
        --    config = function()
        --        require('luaconfig.plugins.sakura')
        --    end,
        --})
        ...
        use({
            ...
            --    after = 'Sakura.nvim',
                event = 'BufEnter',
                config = function()
                    require('luaconfig.plugins.lualine')
                end,
            },
            {
                'j-hui/fidget.nvim',
        ...
        use({
            {
                ...
                run = ':TSUpdate',
                config = function()
                    require('luaconfig.plugins.treesitter')
                end,
            },
        ...
        use({
            ...
            event = 'BufRead',
            config = function()
                require('luaconfig.plugins.indentline')
            end,
        })
...
----    })
        ...
        use({
            ...
            event = 'CursorHold',
            config = function()
                require('luaconfig.plugins.nvim-tree')
            end,
        })
        ...
        use({
            {
                ...
                event = 'CursorHold',
                config = function()
                    require('luaconfig.plugins.telescope')
                end,
            },
            {
        ...
        use({
            ...
            event = 'CursorHold',
            config = function()
                require('luaconfig.plugins.navigator')
            end,
        })
...
--      })
        ...
        use({
            ...
            event = 'BufRead',
            config = function()
                require('luaconfig.plugins.buffers')
            end,
        })
